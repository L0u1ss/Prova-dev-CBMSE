...
class AddPessoa extends React.Component {
    constructor(props) {
        super(props);
    ...
    addPessoa() {
        axios.post('http://localhost/Prova-dev-CBMSE/api/pessoas/adicionar.php', {
                ...
                <div>
                    <form>
                        <Grid container direction="row" alignItems={"center"} spacing={1}>
                            ...
                            <Grid item xs={1}>
                                <Button variant="contained" size="small" color="primary" onClick={() => this.addPessoa()}>
                                    Salvar &nbsp;
                                </Button>
                            </Grid>
                            <Grid item xs={1}>
